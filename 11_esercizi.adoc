...
image::figures/exercises/crunch.svg[]

Esecuzione:: Da supini flettere leggermente le gambe, portare le mani dietro la nuca e seguire la seguente sequenza: 
. rotazione del bacino
. col bacino extraruotato (colonna vertebrale che poggia a terra) contrarre gli addominali, fino a sollevare le spalle.
. decontrarre gli addominali
. riportare in posizione rilassata il bacino.


image::figures/exercises/addominali_dettaglio.svg[]

===== addominali bassi a ponte


image::figures/exercises/addominale_basso.svg[]



===== addominali bassi a ponte

image::figures/exercises/addominale_basso_gamba.svg[]


===== addominali completi

Stessi dettagli degli addominali ma con le gambe solevate da terra

image::figures/exercises/addominale_variante_completa.svg[]
...
image::figures/exercises/crunch_with_weight.svg[]

===== addominali obliqui

Dalla posizione base dell'addominale ruotare le spalle e portarsi alla posizione sotto indicata.

image::figures/exercises/addominali_obliqui.svg[]
...
_Esecuzione_:: 
Il burpee è un esercizio full bodyfootnote:[https://it.wikipedia.org/wiki/Burpee]. Il movimento base si divide in 4 passaggi:
...
image::figures/exercises/burpee.svg[] 
...
image::figures/exercises/bastard_burpee.svg[]
...
image::images/burpee_with_dumbbells.svg[]


==== Camaleonte

_Sinomimi_: ((mossa del camaleonte)), + 
_Esecuzione_: Si parte in quadrupedia, poi si avanza il busto parallelamente al terreno fino a trovarsi in posizione di flessione. Poi ritorno. +
_Effetti_: fa bene.

image::images/camaleonte.svg[]
...
image::figures/exercises/criss_cross.svg[]
    
==== Criss Cross to Teaser

3 movimenti di criss cross e si sta per un secondo in posizione teaser
...
image:figures/exercises/downdog_to_bridge.svg[]
...
image::figures/exercises/ponte.svg[]
...
==== Squat
_Sinomimi_: ((accosciata)), ((air squat)) + 
_Esecuzione_: Esercizio che prevede il passaggio dalla posizione eretta a quella accosciata: gambe flesse oltre i 90°, schiena eretta, peso sulla pianata del piede. Le braccia possono essere parallele al terreno o sollevate. +
_Effetti_: migliora la flessibilità, e la muscolatura. 

image::figures/exercises/air_squat.svg[]

===== Squat Jump

Variante con salto alla fine della posizione eretta
...
image::figures/exercises/squat_and_press_with_dumbbells.svg[]
...
Come lo switch ma ogni 3 switch un jump.

===== Switch Squat

Come lo switch ma ogni 3 switch uno squat.
...
image::figures/exercises/step_up_onto_chair.svg[]
...
image::figures/exercises/superman.svg[] 
...
image::figures/exercises/teaser.svg[]
...
image::figures/exercises/triceps_dip_on_chair.svg[]
...
image::figures/exercises/tuck_jump.svg[]
...
image::figures/exercises/wall_sit.svg[]
...
Esecuzione footnote:[Eventuali riferimenti da ritrovare.]::
...
image::figures/exercises/double_dumbbell.svg[]
...
image::figures/exercises/dumbbell_biceps_curl.svg[]
...
image::figures/exercises/dumbbell_front_raise.svg[]
...
image::figures/exercises/triceps_press.svg[]
...
image::figures/exercises/nome.svg[]
